  ...
  groups: [
    {
      ...
      items: [
        ...
        { to: "/institution-admin/members", label: "Departments", permission: "manage_members", icon: Layers },
        { to: "/institution-admin/members", label: "Campus Leaders", permission: "approve_leaders", icon: ShieldCheck },
        { to: "/institution-admin/members", label: "Students", permission: "manage_members", icon: Users },
      ],
    },
    {
      id: "growth",
    ...
    },
    {
      ...
      label: "Operations",
      items: [
        { to: "/institution-admin", label: "Billing", permission: "manage_institution", icon: IndianRupee },
